...
const TourExclusiveJune = ({ accentColor = "blue-500" }) => {
    return (
		...
		<div style={{textAlign: "justify"}}>
		    &#8226; Обитель Шивы - священная гора Кайлас, место от которого Брахма создавал землю - озеро Манасаровар. Парикарма (Кора).</li>
    ...
    <br /><br />&#8226; Неповторимая культура Тибета с тысячелетней историей. Очень богатая и интересная программа с посещением монастырей, храмов, священных ступ.</li>
    <br /><br />&#8226; Продуманная программа для плавной акклиматизации. Большое кол-во пеших прогулок - треккингов. Сонастройка тонкого тела для совершения парикармы.</li>
		</div>
