...
Overnight in Lhassa, Tibet hotel. </>
			...
			<TimetableDay accentColor={accentColor} title="4 день">
                {translate({
                    ...
                    <TimetablePhoto src="https://img.opentibet.ru/TourTibetExlusiveJune/image07.png"  />
			...
			<TimetableDay accentColor={accentColor} title="7 день">
                {translate({
                    ...
                    <TimetablePhoto src="https://img.opentibet.ru/TourTibetExlusiveJune/image16.jpeg" />
			...
			<TimetableDay accentColor={accentColor} title="8 день">
                {translate({
                    ...
                    <TimetablePhoto src="https://img.opentibet.ru/TourTibetExlusiveJune/image17.jpeg" />                  
